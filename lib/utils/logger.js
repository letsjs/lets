 ...
 * verbose mode.
 *
 * @param mesage (String) The message to log
 * @api public
 */

exports.debug = function (message) {
  exports.emit('debug', message);
};
...
exports.info = exports.log = function (message) {
  exports.emit('info', message);
};
...
exports.error = function (message) {
  exports.emit('error', message.message || message);
};
